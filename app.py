...
def get_Chat_response(text):
    print("text:",text)
    text = text + """ Note:dont use * symbol, with less than 20 words, be creative and short and clear, according to the summary given  respond to greetings review all questions  to answers from the following script----> IMC is a full service Sales and Marketing agency, with our core focuses being the creative and innovative brand solutions on the digital landscape and our vast experience with on-the-ground consumer engagement.We combine strategy, creativity and organization under one roof to deliver top quality work. Our hard work puts us on the map, and our commitment to creative innovation keeps us there. Not only are we a nimble team of qualified personnel, we guarantee positive game changing results with our creative and strategic solutions to smarter marketing.
